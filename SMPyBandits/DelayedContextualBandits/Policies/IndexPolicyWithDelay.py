...
class IndexPolicyWithDelay(BasePolicyWithDelay):
    ...
    def __init__(self, nbArms, lower=0., amplitude=1.):
        ...
        """
        super(IndexPolicyWithDelay, self).__init__(nbArms, lower=lower, amplitude=amplitude)
    ...
    def startGame(self):
        ...
        super(IndexPolicyWithDelay, self).startGame()
        self.index.fill(0)
